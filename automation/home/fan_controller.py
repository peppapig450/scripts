...
""",
    ...
    action_group.add_argument("--fan-off", action="store_true", help="Turn fan off")
    action_group.add_argument("--light-on", action="store_true", help="Turn light on")
    action_group.add_argument("--light-off", action="store_true", help="Turn light off")
    action_group.add_argument(
        "--status", action="store_true", help="Get current fan/light state"
    )

    # Optional configuration
    parser.add_argument(
        "--ip", default="192.168.1.26", help="Fan IP address (default: %(default)s)"
    )
    parser.add_argument(
        "--timeout",
        type=int,
